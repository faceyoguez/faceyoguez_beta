    ...
    <main className="min-h-screen bg-[#FFFAF7] selection:bg-[#e76f51]/10 selection:text-[#e76f51] pb-20">
      ...
      <div className="max-w-7xl mx-auto pt-24 px-6 md:px-8">
        ...
        >
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-[2rem] p-10 border border-[#2c2525]/5 shadow-sm space-y-8 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8">
                 <Globe className="w-16 h-16 text-[#e76f51]/5" />
              </div>
              
              <div className="space-y-6 relative z-10">
                 <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-[#e76f51]/10 text-[#e76f51] text-[10px] font-black uppercase tracking-[0.3em] rounded-full">✨ Face Yoga 21-Day Transformation 🌸</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <motion.div variants={itemVariants} className="bg-[#2c2525] text-white p-8 rounded-[2rem] space-y-8">
                  <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-[#e76f51]">🌿 What Transforms?</h3>
                  <div className="space-y-4">
                     {[
                       ...
                       <div key={i} className="flex gap-4">
                          <Check className="w-4 h-4 text-[#e76f51] mt-0.5" strokeWidth={3} />
                          <div>
               ...
               <div className="space-y-6">
                     ...
                     <div className="space-y-3">
                        {[
                          ...
                          <div key={i} className="flex items-start gap-3 p-3 bg-[#f8f8f8] rounded-xl text-[10px] font-bold text-[#2c2525]/60">
                             <Sparkles className="w-3.5 h-3.5 text-[#e76f51] flex-shrink-0" />
                             <span>{text}</span>
                          </div>
                        ))}
                     </div>
                  ...
                  <motion.div variants={itemVariants} className="bg-[#e76f51]/5 p-8 rounded-[2rem] border border-[#e76f51]/10 space-y-4 text-center">
                     <Heart className="w-6 h-6 text-[#e76f51] mx-auto" />
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-[2rem] p-10 border border-[#2c2525]/5 grid grid-cols-1 md:grid-cols-2 gap-12">
               ...
               <div className="space-y-8">
                  <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-[#e76f51]">🌸 What You Walk Away With</h3>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={idx} className="flex gap-3 text-[10px] font-bold uppercase tracking-wider text-[#2c2525]/70">
                        <Check className="w-3 h-3 text-[#e76f51] mt-0.5" strokeWidth={3} />
                        {item}
                      </div>
                    ))}
                  </div>
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-6">
            ...
            {/* PRICING SELECTOR */}
            <motion.div variants={itemVariants} className="bg-white rounded-[2.5rem] p-8 border-2 border-[#e76f51]/10 shadow-xl space-y-8 overflow-hidden relative">
      ...
      <footer className="mt-20 border-t border-[#2c2525]/5 pt-20 pb-10 px-8 text-center max-w-4xl mx-auto space-y-8">
           <h2 className="text-4xl font-light text-[#2c2525] leading-tight" style={{ fontFamily: 'var(--font-cormorant)' }}>
             This isn't a course. <br /> <span className="italic text-[#e76f51]">It's a New Standard of Radiance.</span>
           </h2>
           <button 
              onClick={() => {
