    ...
    <main className="min-h-screen bg-[#FFFAF7] selection:bg-[#e76f51]/10 selection:text-[#e76f51] pb-20">
      ...
      <div className="max-w-7xl mx-auto pt-24 px-6 md:px-8">
        ...
        >
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-[2rem] p-10 border border-[#2c2525]/5 shadow-sm space-y-8 relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-8 transform group-hover:rotate-12 transition-transform duration-700">
                 <Layers className="w-16 h-16 text-[#e76f51]/5" />
              </div>
              
              <div className="space-y-6 relative z-10">
                 <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-[#e76f51]/10 text-[#e76f51] text-[10px] font-black uppercase tracking-[0.3em] rounded-full">✨ Recorded Plan — Lifetime Access</span>
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="bg-white p-8 rounded-[2rem] border border-[#2c2525]/5 space-y-6">
                  <div className="flex justify-between items-center">
                     <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#e76f51]">🌱 Level 1</span>
                     <span className="text-[9px] font-bold text-[#e76f51] uppercase border border-[#e76f51]/20 px-2 py-0.5 rounded-full">16 Sessions</span>
                  </div>
                  ...
                  <ul className="space-y-3">
                     {[
                       ...
                       <li key={idx} className="flex gap-3 text-[10px] font-bold text-[#2c2525]/60 uppercase tracking-widest">
                          <Check className="w-3.5 h-3.5 text-[#e76f51] mt-0.5 flex-shrink-0" strokeWidth={3} />
                          {item}
                       </li>
                     ))}
                  </ul>
               ...
               <div className="bg-[#2c2525] p-8 rounded-[2rem] text-white space-y-6">
                  <div className="flex justify-between items-center">
                     <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#e76f51]">🔥 Level 2</span>
                     <span className="text-[9px] font-bold text-[#e76f51] uppercase border border-[#e76f51]/20 px-2 py-0.5 rounded-full">16 Sessions</span>
                  </div>
                  ...
                  <div className="space-y-6">
                     {[
                       ...
                       <div key={idx} className="flex gap-4 group">
                          <span className="text-[10px] font-black text-[#e76f51]">0{idx+1}</span>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                     {[
                       ...
                       <div key={idx} className="flex items-center gap-4 p-4 bg-[#fcf8f7] rounded-2xl border border-[#2c2525]/5">
                          <item.i className="w-4 h-4 text-[#e76f51] flex-shrink-0" />
                          <div className="space-y-0.5">
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {workOn.map((item, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-[8px] font-bold uppercase tracking-widest text-[#2c2525]/50 group">
                       <Check className="w-2.5 h-2.5 text-[#e76f51] group-hover:scale-125 transition-transform" strokeWidth={4} />
                       {item}
                    </div>
                  ))}
               </div>
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-6">
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-[2.5rem] p-8 border border-[#e76f51]/20 shadow-xl space-y-10 overflow-hidden relative">
               <div className="absolute top-0 left-0 w-full h-1 bg-[#e76f51]" />
               <div className="text-center space-y-2">
                   <ShieldCheck className="w-8 h-8 text-[#e76f51] mx-auto opacity-40" strokeWidth={1.5} />
                   <span className="text-[9px] font-black uppercase tracking-[0.4em] text-[#e76f51]">One-Time Payment</span>
               ...
               <div className="p-6 bg-[#2c2525] rounded-3xl space-y-4">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#e76f51]">Access Duration</span>
                  </div>
            ...
            <motion.div variants={itemVariants} className="p-6 border-2 border-dashed border-[#e76f51]/10 rounded-3xl space-y-4 text-center">
               <Heart className="w-6 h-6 text-[#e76f51] mx-auto opacity-20" />
      ...
      <footer className="mt-20 border-t border-[#2c2525]/5 pt-20 pb-10 px-8 text-center max-w-4xl mx-auto space-y-8">
           <h2 className="text-4xl font-light text-[#2c2525] leading-tight" style={{ fontFamily: 'var(--font-cormorant)' }}>
             The plan does the work. <br /> <span className="italic text-[#e76f51]">You just have to show up.</span>
           </h2>
           <button 
              onClick={() => {
