...
export const metadata: Metadata = {
  ...
  description: 'Join Harsimrat — India\'s #1 Face Wellness Coach — for a free live session every Monday. Discover the facial muscle techniques that 2,000+ women use to visibly lift, tone, and glow. No creams. No needles. No surgery.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Every Monday. Free. Live on Zoom. Discover what 2,000+ Indian women used to visibly lift and tone their face — in just 10 minutes a day.',
  ...
  twitter: {
    ...
    description: 'Every Monday. Free. Live on Zoom. No creams. No needles. Just results.',
