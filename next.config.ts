    ...
    // ── Security headers for all routes ──
    {
      ...
      headers: [
        ...
        { key: 'X-XSS-Protection', value: '1; mode=block' },
        {
          ...
          value: [
            "default-src 'self'",
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://connect.facebook.net https://checkout.razorpay.com https://cdn.razorpay.com https://www.youtube.com https://s.ytimg.com https://www.clarity.ms https://*.clarity.ms",
            "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
            "img-src 'self' data: blob: https://*.supabase.co https://images.unsplash.com https://i.ytimg.com https://*.razorpay.com https://www.facebook.com https://*.googleusercontent.com https://drive.google.com https://*.google.com https://*.clarity.ms https://c.bing.com",
