              ...
              <div className="mt-8 px-5 py-4 mx-3 rounded-2xl bg-[#FF8A75]/5 border border-[#FF8A75]/10 flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="flex-1 py-2 px-3 rounded-xl bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-all flex items-center justify-center gap-1.5 text-[9px] font-black uppercase tracking-wider"
                  >
                    <img src="/assets/whatsapp_icon.png" alt="" className="w-5 h-5 object-contain" />
                    WhatsApp
                  </a>
                  <a
                    href="mailto:management@faceyoguez.com"
                    className="flex-1 py-2 px-3 rounded-xl bg-[#bc162d]/10 text-[#bc162d] hover:bg-[#bc162d]/20 transition-all flex items-center justify-center gap-1.5 text-[9px] font-black uppercase tracking-wider"
                  >
                    <img src="/assets/gmail_icon.png" alt="" className="w-5 h-5 object-contain" />
                    Mail
                  </a>
                </div>
              </div>
