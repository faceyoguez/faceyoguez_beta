      ...
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 md:p-12 overflow-hidden" style={{ pointerEvents: 'auto' }}>
        ...
        >
          ...
          <div className="flex-shrink-0 p-6 bg-[#faf7f2] border-t border-[#2a2019]/5">
             <button onClick={() => { onClose(); startGuestBrowsing('/student/plans?plan=group_session'); }} className="w-full bg-[#2a2019] text-white py-4 rounded-full text-[10px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 hover:bg-[#2a2019]/90 transition-all shadow-xl">
